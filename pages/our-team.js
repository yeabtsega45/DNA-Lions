...
export default function OurTeam() {
  return (
    <>
      <Layout breadcrumbTitle="Our Team">
        <div>
                          ...
                          <div className="col-lg-8">
                            <div className="left_content">
                              ...
                              <div className="quotes">
                                ...
                                <h5>
                                  Teamwork is the secret that <br /> makes
                                  common people achieve <br />
                                  uncommon results.
                                </h5>
                              </div>
                ...
                <div className="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-xs-12 mb-4 mb-lg-4 mb-xl-0">
                  <div className="icon_box_all style_four">
                    <div className="icon_content icon_imgs">
                      <div className="icon">
                        <img
                          src="/assets/images/icon-img-n-3.png"
                ...
                <div className="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-xs-12 mb-4 mb-lg-4 mb-xl-0">
                  <div className="icon_box_all style_four">
                    <div className="icon_content icon_imgs ">
                      <div className="icon">
                        <img
                          src="/assets/images/icon-img-n-4.png"
                          className="img-fluid svg_image"
                          alt="icon png"
                        />
                        <img
                      ...
                      <div className="txt_content">
                        <h3>
                          <Link href="#">
                            Team is available 7<br />
                            days a week
                          </Link>
                        </h3>
                        <p>
                          No one rejects dislikes avoids sure but because those
                          who do.
                        </p>
                      </div>
                    </div>
                ...
                <div className="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-xs-12 mb-4 mb-lg-4 mb-xl-0">
                  <div className="icon_box_all style_four">
                    <div className="icon_content icon_imgs ">
                      ...
                      <div className="txt_content">
                        <h3>
                          <Link href="#">Focused on achieving results</Link>
                        </h3>
                        <p>
                          Loves or pursues or desires obtain of itself because
                          it is pain.
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="icon_box_all style_four">
                    <div className="icon_content icon_imgs">
                      ...
                      <div className="txt_content">
                        ...
                        <p>
                          Trivial example which of us ever all undertakes
                          laborious.
                        </p>
                      </div>
                    </div>
          ...
          {/*-team section-*/}
          <section className="image-section-two">
            {/*===============spacing==============*/}
            <div className="pd_top_90" />
            {/*===============spacing==============*/}
            <div className="container">
              <div className="row">
                ...
                <div className="col-xl-6 col-lg-12">
                  ...
                  <div className="creote-themebtns">
