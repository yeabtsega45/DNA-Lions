        ...
        <div>
          <div className="full_width_box">
            ...
            <section
              ...
              style={{
                backgroundImage: "url(../assets/images/testimonialbg.jpg)",
              }}
            >
                ...
                <div className="col-xxl-5 col-xl-5 col-lg-5 col-md-12 pd_zero">
                  <div className="image">
                    <img
                      ...
                      className="simp_img img-fluid height_560px"
                      alt="image"
                    />
                  </div>
                </div>
                          ...
                          <SwiperSlide>
                            <div className="testimonial_box">
                              ...
                              <div className="comment">
                                ...
                                feels hard, that’s why it’s been so nice to have
                                our accounting feel easy. We recommed Qetus.
                              </div>
                            </div>
                          </SwiperSlide>
                          <SwiperSlide>
                ...
                <div className="col-lg-12">
                  <div className="title_all_box style_three text-center dark_color">
                    <div className="title_sections three">
                      ...
                      <h2>Customers Experience</h2>
                      <p>
                        Shared Time Human Resources Management, Inc. performs
                        executive <br /> searches and professional recruitment
                        for our clients.
                      </p>
                    </div>
                    {/*===============spacing==============*/}
                  ...
                  <Swiper {...swiperOptions3}>
                    ...
                    <SwiperSlide>
                      <div className="testimonial_box">
                        ...
                        <div className="pic">
                          <img
                            src="../assets/images/about-us-1-min.png"
                            alt="image"
                          />
                        </div>
                        <div className="rating">
                      ...
                      <Swiper {...swiperOptions1}>
                        <SwiperSlide>
                          <div className="testimonial_box clearfix">
                            <div className="image">
                              <img
                                src="../assets/images/banner-four-bg.jpg"
                                alt="image"
                              />
                            </div>
                        ...
                        <SwiperSlide>
                          <div className="testimonial_box clearfix">
                            <div className="authour_details">
                              ...
                              <div className="comment">
                                Affordable and refreshingly easy to use HR
                                management software for small to medium
                                businesses. CakeHR is built with ease of use in
                                mind.Unlike older HR platforms which can be
                                painfully slow and complex
                              </div>
                              <div className="details clearfix">
                                <div className="c_content">
                                  <div className="content_in">
              ...
              <div className="row">
                <div className="col-lg-12">
                  <div className="testimonial_all owl_new_one ">
                    <Swiper
                      {...swiperOptions2}
                      className="owl_nav_block owl_dots_none owl_type_two theme_carousel"
                    >
                      <SwiperSlide className="testimonial_box type_one">
                        ...
                        <div className="testimonial_inner">
                          <div className="description">
                            <p>
                              I love creote everyone has been great to work with
                              and you’re all great partner for company, we thank
                              you ...{" "}
                            </p>
                          </div>
                      ...
                      <SwiperSlide className="testimonial_box type_one">
                        ...
                        <div className="testimonial_inner">
                          <div className="description">
                            <p>
                              We hired creote to assist us with refining
                              marketing plans, you truly understands &amp; gave
                              us very good ideas.{" "}
                            </p>
                          </div>
                          <div className="lower_content clearfix">
                      ...
                      <SwiperSlide className="testimonial_box type_one">
                        ...
                        <div className="testimonial_inner">
                          <div className="description">
                            <p>
                              You bring tremendous value to company. We have
                              generated more leads in the last 45 days.{" "}
                            </p>
                          </div>
                          <div className="lower_content clearfix">
                            <div className="image_box">
                      ...
                      <SwiperSlide className="testimonial_box type_two">
                        <div className="upper_content">
                          ...
                          <div className="description">
                            <p>
                              You bring tremendous value to company. We have
                              generated more leads in the last 45 days than the
                              last 2 days ...
                            </p>
                          </div>
                        </div>
