...
export default function Breadcrumb({
  ...
  return (
    <>
      <div
        className={`page_header_default style_one ${
          blogMetaSingle ? "blog_single_pageheader" : ""
        }`}
      >
        <div className="parallax_cover">
          <div className="simpleParallax">
            <img
              src={breadcrumbImage || "/assets/images/page-header-default.jpg"}
              alt="bg_image"
                ...
                <div className="col-md-12">
                  <div className="left_side">
                    ...
                    <div className="comments">
                      ...
                      <a href="#comment" className="Comments are Closed">
                        Post Comment
                      </a>
                    </div>
                  </div>
