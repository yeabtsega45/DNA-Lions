              ...
              <div className="title_all_box style_six  dark_color">
                <div className="title_sections">
                  ...
                  <p className="description_text">
                    Over 20 years of experience we’ll ensure you always get the
                    best . We serve a clients at every level of their
                    organization we can be most useful, whether as a trusted
                    advisor to top trusted our management.
                  </p>
                </div>
              </div>
              {/*===============spacing==============*/}
              ...
              <div className="row gutter_25px">
                ...
                <div className="col-lg-6 col-md-6 col-sm-12">
                  <div className="icon_box_new_box type_one">
                    ...
                    <div className="text_box">
                      <h2>
                        <Link href="#">Best Solution</Link>
                      </h2>
                      <p>
                        Consult Solution is a dynamic, multipurpose, elegant and
                        modern corporate and business.
                      </p>
                    </div>
                  </div>
                </div>
