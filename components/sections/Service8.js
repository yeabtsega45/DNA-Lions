            ...
            <div className="row gutter_30px">
              <div className="col-xl-6 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div className="description_box color_white text-md-end">
                  <p>
                    In job gives you handcrafted options such as front admin
                    reviews or email notifications. It also gives employer
                    management for apps. It has panel/dashboard options for both
                    companies to professional individuals in to social media
                  </p>
                </div>
              </div>
              <div className="col-xl-6 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  ...
                  <div className="service_content">
                    ...
                    <div className="content_inner">
                      ...
                      <div className="text_box">
                        <h2>
                          <Link href="#">Build Business Credit</Link>
                        </h2>
                        <p>
                          Establish business credit using your EIN—no personal
                          guarantee required!
                        </p>
                      </div>
                    </div>
                ...
                <div className="service_box style_five dark_color mr_top_minus_160 mr_md_top_zero">
                  <div className="service_content">
                    ...
                    <div className="content_inner">
                      ...
                      <div className="text_box">
                        <h2>
                          <Link href="#">Entity Formation</Link>
                        </h2>
                        <p>
                          Hassle-free LLC registration, EIN setup, and tax
                          account creation.
                        </p>
                      </div>
                    </div>
                ...
                <div className="service_box style_five dark_color mr_top_minus_160 mr_md_top_zero">
                  <div className="service_content">
                    ...
                    <div className="content_inner">
                      ...
                      <div className="text_box">
                        <h2>
                          <Link href="#">Taxes & Bookkeeping</Link>
                        </h2>
                        <p>
                          Expert tax preparation, filing, and bookkeeping
                          services.
                        </p>
                      </div>
                    </div>
