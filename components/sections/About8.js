            ...
            <div className="col-xl-6 col-lg-12 mb-5 mb-lg-5 mb-xl-0">
              <div className="image_boxes style_three">
                <img
                  ...
                  className="img-fluid height_530px object-fit-cover"
                  alt="image"
                />
            ...
            <div className="col-xl-6 col-lg-12">
              <div className="title_all_box style_one dark_color">
                <div className="title_sections ">
                  <div className="before_title"> Tax Software </div>
                  <h2>DNA LIONS SOFTWARE</h2>
                  <p>
                    The ultimate desktop tax software solution designed for busy
                    tax offices that demand speed, accuracy, and efficiency.
                  </p>
                </div>
              </div>
              {/*===============spacing==============*/}
              ...
              <div className="progress_bar style_two">
                ...
                <div className="content_box">
                  ...
                  <p>
                    Trusted by industry professionals, our software streamlines
                    tax preparation and faster processing for your clients.
                  </p>
                </div>
              </div>
              {/*===============spacing==============*/}
